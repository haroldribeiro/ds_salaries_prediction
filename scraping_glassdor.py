...
def get_jobs(keyword,days,num_jobs, verbose,s_time):
    ...
    driver = webdriver.Chrome(executable_path="/Users/haroldribeiro/OneDrive/Documents/Studies/Data Science/DS Portfolio/Web Scraping Glassdor/chromedriver", options=options)
    driver.set_window_size(1120, 1000)

    #url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword="' + keyword + '"&locT=C&locId=1147401&locKeyword=San%20Francisco,%20CA&jobType=all&fromAge=-1&minSalary=0&includeNoSalaryJobs=true&radius=100&cityId=-1&minRating=0.0&industryId=-1&sgocId=-1&seniorityType=all&companyId=-1&employerSizes=0&applicationType=0&remoteWorkType=0'
    #url = "https://www.glassdoor.com/Job/jobs.htm?fromAge=suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword="+keyword+"&sc.keyword="+keyword+"&locT=&locId=&jobType="
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        for job_button in job_buttons:  
            ...
            while not collected_successfully:
                try:
                    print("entrou no try do collected")
                    ...
                    print("deu ruim no try do collected")
                    time.sleep(5)
